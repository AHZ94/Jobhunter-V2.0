  ...
  <body>
		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-left">
					<div class="collapse navbar-collapse" id="navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li><a href="/Jobhunter_V2.0/ListHandler?action=applyListss&email=<c:out value="<%=email%>"/>">Job Posted</a></li>							 
							<li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Pages<span class="caret"></span></a>
								<ul class="dropdown-menu">
									...
									<li><a href="/Jobhunter_V2.0/JobsHandler?action=createJobs&email=<c:out value="<%=email%>"/>">Job Post</a></li>			
									<li><a href="/Jobhunter_V2.0/ListHandler?action=viewList&email=<c:out value="<%=email %>"/>">Job List</a></li>
									<li><a href="/Jobhunter_V2.0/ListHandler?action=applyListss&email=<c:out value="<%=email%>"/>">Apply Jobs</a></li>																
									<li><a href="/Jobhunter/EmployerHandler?action=Logout">Logout</a></li>
									<li><a href="/Jobhunter_V2.0/Employer/maintenance.jsp">Maintenance</a></li>									
								</ul>
							</li>
						</ul>
					</div>
				...
				<div class="nav-right">				
					...
					<!-- sign-in -->					
					<a href="/Jobhunter_V2.0/JobsHandler?action=createJobs&email=<c:out value="<%=email%>"/>" class="btn">Post Your Job</a>
				</div>
				<!-- nav-right -->
			</div><!-- container -->
		</nav><!-- navbar -->
	...
	<div class="banner-job">
		...
		<div class="container text-center">
			<h1 class="title">Get Your Part-Time Job</h1>
			<h3>With Jobhunter </h3>
				...
				<ul class="category-list">	
					...
					<li class="category-item">
						<a href="job-list.jsp">
							...
							<span class="category-title">Human Resources & Office</span>							
						</a>
					</li><!-- category-item -->
					...
					<li class="category-item">
						<a href="job-list.jsp">
							...
							<span class="category-title">Logistic & Financial</span>							
						</a>
					</li><!-- category-item -->
					...
					<li class="category-item">
						<a href="job-list.jsp">
							...
							<span class="category-title">Associates</span>							
						</a>
					</li><!-- category-item -->
					...
					<li class="category-item">
						<a href="job-list.jsp">
							...
							<span class="category-title">Research</span>							
						</a>
					</li><!-- category-item -->
