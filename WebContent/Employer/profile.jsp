		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="Employer/Emp-index.jsp"><img class="img-responsive" src="images/logo.png" alt="Logo"></a>
				</div>
				<!-- /navbar-header -->
		...
		<div class="container">						
			<div class="job-profile section">	
				<div class="user-profile">
					...
					<div class="user">
						<h2>Hello, <c:out value="${emp.name}" /></h2>
					</div>

					<div class="favorites-user">						
						<div class="favorites">
							<a href="bookmark.html">20<small>Apply</small></a>
						</div>
					</div>								
				</div><!-- user-profile -->
			...
			<div class="resume-content">
				<div class="profile section clearfix">
					...
					<div class="personal-info">				    	
				        <ul class="address">				       
				            <li><h5>Name </h5> <span>:</span><c:out value="${emp.name}" /></li>				            
				            <li><h5>Phone </h5> <span>:</span><c:out value="${emp.phone}" /></li>
				            <li><h5>Email</h5> <span>:</span><a href="#"><c:out value="${emp.email}" /></a></li>
				            <li><h5>Company</h5> <span>:</span><c:out value="${emp.compname}" /></li>
				            <li><h5>Industry</h5> <span>:</span><c:out value="${emp.industry}" /></li>
				            <li><h5>Address</h5> <span>:</span><a href="#"><c:out value="${emp.address}" /></a></li>				            				            
				        </ul>    	
				    	</div>						
				</div><!-- profile -->
