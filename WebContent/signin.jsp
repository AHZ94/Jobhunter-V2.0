		...
		<div class="container">
			<div class="row text-center">
				...
				<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
						...
						<h2>Login</h2>
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="Student">
									<form class="login-form" method="get" action="/Jobhunter/LoginHandler">
								...
								<div role="tabpanel" class="tab-pane" id="Employer">
									<form class="login-form" method="get" action="LoginEmployer">
										<div class="form-group">
											<input type="email" class="form-control" placeholder="Email" id="email" name="email" required>
										</div>
										<div class="form-group">
					...
					<a href="signup.jsp" class="btn-primary">Create a New Account</a>
				</div><!-- user-login -->			
			</div><!-- row -->	
		</div><!-- container -->
	</section><!-- signin-page -->
